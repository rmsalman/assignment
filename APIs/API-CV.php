<?php 
	$url = "https://api.bayt.com/api/view-cv/?token=oL9Ou7vIsqUFexquVUcpP2PZOg5SEPIJ&company_token=lklJjMj6Ta2wCfk5dSXJ6cF8E2m9kWZ&company_id=1435096&cv_id=".$_GET['cv_id']."&icode=".urlencode($_GET['icode']);
